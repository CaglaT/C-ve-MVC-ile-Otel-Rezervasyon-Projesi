...
namespace OtelYeniProje.Formlar.Urun
{
    public partial class FrmUrunKarti : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            repo.TAdd(t);
            XtraMessageBox.Show("Ürün Bilgileri Başarıyla Kaydedildi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            XtraMessageBox.Show("Ürün Bilgileri Başarıyla Güncellendi");
        }
